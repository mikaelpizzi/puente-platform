...
- **Why:** Permitir a los vendedores organizar su inventario m�s all� de las verticales r�gidas.
- **How:**
  - **Backend:** TagsModule con TagSchema (name, sellerId, color). TagsService gestiona CRUD y l�mite de 30 tags.
  - **Frontend:** TagManager modal para crear/eliminar tags. Integraci�n en InventoryDashboard.
- **Outcome:** DONE. Vendedores pueden crear sus propias categor�as.
...
- **What:** Mejoras de UI en Inventario y asignaci�n masiva de etiquetas.
- **Why:** Facilitar la gesti�n de cat�logos grandes.
- **How:**
  - Implementaci�n de selecci�n estilo iOS (chips, checkmarks).
  - Modal de asignaci�n masiva que permite *agregar* etiquetas a m�ltiples productos respetando l�mites.
- **Outcome:** DONE. UX mejorada significativamente.
- **Testing:** Verificaci�n manual de flujo de selecci�n y asignaci�n.

## Multi-tag Support & Limits
- **What:** Soporte para m�ltiples etiquetas por producto y en filtros.
- **Why:** Un producto puede pertenecer a varias categor�as (ej. 'Oferta' + 'Verano').
- **How:**
  - **Backend:** Product schema actualizado con 	ags: string[].
  - **Frontend:** ProductCard muestra chips. CheckoutPage filtra por tags. Validaci�n de max 5 tags/producto.
- **Outcome:** DONE. Flexibilidad total en categorizaci�n.
- **Testing:** Builds exitosos. L�gica de filtrado en Checkout validada por c�digo.
